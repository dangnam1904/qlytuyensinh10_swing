...
public String toString() {
	return "HocSinh [maHS=" + maHS + ", sBD=" + sBD + ", maTruongC2=" + maTruongC2 + ", hoten=" + hoten + ", diaChi="
			+ diaChi + ", nvong1=" + nvong1 + ", nvong2=" + nvong2 + ", hocLuc=" + hocLuc + ", chuThich=" + chuThich
			+ ", gioiTinh=" + gioiTinh + ", khoiChuyen=" + khoiChuyen + ", diemCong=" + diemCong + ", diemHK9="
			+ diemHK9 + ", ngaySinh=" + ngaySinh + "]";
}
public HocSinh(String maHS, String sBD, String maTruongC2, String hoten, String diaChi, String nvong1, String nvong2,
		String hocLuc, String chuThich, boolean gioiTinh, boolean khoiChuyen, int diemCong, float diemHK9,
		Date ngaySinh) {
