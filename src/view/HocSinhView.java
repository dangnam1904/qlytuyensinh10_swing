...
public class HocSinhView extends JFrame {
	...
	public HocSinhView() {
		...
		scrollPane.setBounds(58, 279, 777, 204);
		contentPane.add(scrollPane);
		
		JPanel panel = new JPanel();
		panel.setBackground(new Color(64, 128, 128));
		panel.setBounds(124, 501, 623, 54);
		...
		cb_truongc2.setBounds(108, 97, 159, 21);
		contentPane.add(cb_truongc2);
		
		JLabel lblNewLabel_1_1 = new JLabel("Tên Trường");
		lblNewLabel_1_1.setBounds(25, 101, 63, 14);
	...
	public void insertDataTruongC2() {
		...
		if(ma.equals("") || txt_tentruongc2.getText().trim().equals("")) {
			...
			if(TruongC2DAO.getATruongC2(txt_matruongc2.getText().trim())==null) {
				TruongC2DAO.insertDataTruongC2(new TruongC2(txt_matruongc2.getText().trim(), txt_tentruongc2.getText().trim(),txt_diachitruongc2.getText().trim() , txt_ghichu.getText().trim()));
				readData();
			}else {
	...
	public void editTruongC2() {
		if(maTruong=="") {
			...
			TruongC2DAO.UpdateTruongC2(new TruongC2(maTruong, txt_tentruongc2.getText().trim(),txt_diachitruongc2.getText().trim() , txt_ghichu.getText().trim()));
			readData();
		}
