...
public class TruongC3View extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TruongC3View frame = new TruongC3View();
	...
	public TruongC3View() {
		...
		lblNewLabel_1.setBounds(25, 117, 63, 14);
		...
		txt_tentruongc2.setBounds(109, 114, 213, 20);
		...
		scrollPane.setBounds(25, 273, 798, 172);
		contentPane.add(scrollPane);
		
		JPanel panel = new JPanel();
		panel.setBackground(new Color(64, 128, 128));
		panel.setBounds(112, 486, 623, 54);
		...
		cb_quan.setBounds(119, 57, 152, 22);
